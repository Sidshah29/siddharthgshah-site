...
export const hero = {
  ...
  statusContext:
    "Working, Learning and Researching in Applied AI, Fintech Infrastructure, and Data Analytics",
  // Two-line headline. "sharpening" gets italic + ember accent in the component.
  headlineLine1: "Three disciplines.",
  headlineLine2Prefix: "Perscrutating, ",
  headlineLine2Accent: "Ratiocinating",
  headlineLine2Suffix: ".",
  byline:
...
export const education = {
  ...
  personal: [
    "Geopolitics",
    "International Fiscal Policy and Economics",
    "NLP and Financial Market Analytics",
...
export const nowBuildingKicker = {
  marker: "SECTION 02 / Developing;)",
  title: "three projects taking off soon; one about to land.",
  subtitle:
...
export const receiptsKicker = {
  marker: "SECTION 05 / Journey Onward",
  subtitle:
...
export const mindMarginTease = {
  ...
  subtitle: "I read, I write, I observe - I thrive",
  // Photography tile uses the first 5 photos.
  photoCount: 5,
  photoLink: "Find all the frames live at  Mind & Margin →",
...
export const photographyAll: PhotoCell[] = Array.from(
  { length: 25 },
  (_, i) => ({
    src: `/photos/${String(i + 1).padStart(2, "0")}.jpg`,
    alt: `Photograph ${String(i + 1).padStart(2, "0")}`,
